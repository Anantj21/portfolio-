...
export default function Navbar({ darkMode, toggleDarkMode, isNavbarVisible }) {
  ...
  return (
    <nav
      className={`${
        darkMode ? "bg-gray-800 bg-opacity-0" : "bg-white bg-opacity-70"
      } backdrop-filter backdrop-blur-lg fixed w-full z-10  transition-transform duration-300 ease-in-out ${
